...
use App\Http\Controllers\SiteContato;
...
Route::get('/contato', [SiteContato::class, 'contato'])->name('site.contato');
Route::post('/contato/store', [SiteContato::class, 'store_contato'])->name('site.store');
